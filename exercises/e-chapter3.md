...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions3/Exercise01To03.html)
...
[_Solution_](https://codesample.info/samples/designbook/solutions3/Exercise04.html)
...
[_Solution_](https://codesample.info/samples/designbook/solutions3/Exercise01To03.html)
...
[_Solution_](https://codesample.info/samples/designbook/solutions3/Exercise06.html)
...
[_Solution_](https://codesample.info/samples/designbook/solutions3/Exercise08.html)

## Exercise 9

Enhance class `Hand` so that it is kept in *sorted order* using a parameterizable sorting order. Use the Strategy pattern and dependency injection to allow clients to specify how cards should be sorted. The cards in the hand should be sorted according to the required order at all times.

[_Solution_](https://codesample.info/samples/designbook/solutions3/Exercise09.html)
...
[_Solution_](https://codesample.info/samples/designbook/solutions3/Exercise10.html)

## Exercise 11 🔍

Review the code of class `Foundations` in the [Solitaire application (Version 1.3)](https://github.com/prmr/Solitaire/tree/v1.3) and create a class diagram that captures the main design decisions for this class.

[_Solution_](https://codesample.info/samples/designbook/solutions3/Exercise11.html)
