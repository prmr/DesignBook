...
Consider interface [Show](../exercise-code/chapter6/Show.java) and the two implementing classes [Movie](../exercise-code/chapter6/Movie.java) and [Concert](../exercise-code/chapter6/Concert.java). Apply the Composite design pattern to provide support for a kind of show that is a combination of between two and five shows, inclusively. Write a client program that creates a show that consists of a concert followed by two movies, where the two movies are, together, represented by a single `Show` object.

[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise01.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise02.html)

## Exercise 3

Draw a class diagram of your combined design for exercises 1 and 2.

[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise03.html)

## Exercise 4

Draw an object diagram of the object graph created as part of exercise 2.

[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise04.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise05.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise06.html)

## Exercise 7

Implement a variant of the feature described in Exercise 7, but this time by modifying the `Show` interface. 

[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise07.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise08.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise09.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise10.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise11.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise12.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise13.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise14.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise15.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise16.html)

## Exercise 17

Extends the `CommandProcessor` so that is supports *redoing* commands (that is, executing undone commands).

[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise17.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions6/Exercise18.html)
