...
Consider the [Show](../exercise-code/chapter7/Show.java) interface and the two implementing classes [Movie](../exercise-code/chapter7/Movie.java) and [Concert](../exercise-code/chapter7/Concert.java). Create a class `SponsoredConcert` that is a subtype of `Concert` with two additional pieces of data: a sponsor name (`String`) and a sponsor time (`int`) that represents the number of minutes the sponsor is allocated to advertise as part of the show. A call to `description()` on an instance of `SponsoredConcert` should include the title and performer of the concert, along with the name of the sponsor. A call to `time()` on an instance of `SponsoredConcert` should return the time of the concert plus the time allocated to the sponsor. Extend the `description()` method so that it includes the total time of the concert.

[_Solution (and more)_](https://codesample.info/samples/designbook/solutions7/Exercise01.html)

## Exercise 2

Change the code of `Concert` so that the field `aPerformer` is `private`. What are possible solutions for accessing this information? How else can you improve the encapsulation of the class?

[_Solution (and more)_](https://codesample.info/samples/designbook/solutions7/Exercise02.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions7/Exercise03.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions7/Exercise04.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions7/Exercise05.html)
...
[_Solution (and more)_](https://codesample.info/samples/designbook/solutions7/Exercise06.html)
