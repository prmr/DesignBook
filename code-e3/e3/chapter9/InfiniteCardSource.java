...
/**
 * Demonstrates how to use the Supplier interface to obtain card in the context
 * of a card source that can supply an infinity of card.
 * 
 * See Section 9.4
 */
public class InfiniteCardSource implements CardSource {
	...
	public static void main(String[] args) {
		InfiniteCardSource randomCards = new InfiniteCardSource(Deck::randomCard);
