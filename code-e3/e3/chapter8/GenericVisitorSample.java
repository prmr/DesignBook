...
/**
 * This source code file shows how to use generic types to apply the Visitor
 * pattern so that data flow is accomplished via parameters and return types, as
 * opposed to state accumulation within the visitor. This is a simplified
 * version of the CardSource sample referenced in the chapter.
 */
public class GenericVisitorSample {

	public static void main(String[] args) {
		GenericCardSource root = new GenericCompositeCardSource(new GenericDeck(),
				new GenericCompositeCardSource(new GenericDeck(), new GenericCompositeCardSource(new GenericDeck()),
						new GenericDeck()),
				new GenericDeck());
