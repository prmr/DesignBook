...
interface Command
{
    /*?
     * Keyword: execute
     * We define a single method `execute()` which is used to execute the command and is implemented by all concrete commands that implement the interface `Command`.
     */
	void execute();
}
