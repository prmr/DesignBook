...
public class ObservableDeck 
{
	...
	public void shuffle()
	{
        /*?
         * Keyword: clear
         * clear removes all the cards from the deck.
         */
		aCards.clear();
        ...
        /*?
         * Keyword: shuffle
         * Collections.shuffle shuffles the deck of cards.
         */
		...
		for(DeckObserver observer : aObservers)
		{
            /*?
             * Keyword: shuffled
             * shuffled is a method in the DeckObserver interface that is called after the deck has been shuffled. It takes no parameters and returns nothing. shuffled notifies the observer that the deck has been shuffled.
             */
			observer.shuffled();
		}
	}
