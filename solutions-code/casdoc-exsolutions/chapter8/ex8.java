...
public class LuckyNumber extends Application
{
    ...
    public void start(Stage pPrimaryStage) 
    {
        ...
        /*?
         * Keyword: ENGLISH
         * This is a array of strings that contains the English words for the numbers 0 to 10.
         */
        final String[] ENGLISH = {"Zero", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten"};

        /*?
         * Keyword: ROMAN
         * This is a array of strings that contains the Roman numerals for the numbers 0 to 10.
         */
        final String[] ROMAN = {"nullus", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X"};
        ...
        oot.add(new TextPanel(model, ENGLISH), 0, 2, 1, 1);
...
class TextPanel extends HBox implements Observer
{
	/*?
	 * Keyword: aLabels
	 * `LABELS` is now an instance field `aLabels`.
	 */
	...
	/**
	 * @param pModel The model observed by this panel.
	 * @param pLabels The labels to use for the numbers.
	 * @pre pLabels != null && pLabels.length == 11
	 */
	TextPanel(Model pModel, String... pLabels)
	{
		...
		/*?
		 * Keyword: copyOf
		 * `Arrays.copyOf` is used to copy the array `pLabels` into the instance field `aLabels`.
		 */
